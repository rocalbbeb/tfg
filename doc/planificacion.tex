...
Todo el proceso de creación del proyecto ha sido gestionado y documentado en el repositorio de {\textbf{GitHub}}: https://github.com/rocalbbeb/tfg.git 

En el mismo, se han registrado las tareas realizadas, los cambios efectuados y las decisiones tomadas. Extrayendo la información del repositorio, queda reflejado en este capítulo de forma precisa la evolución del proyecto.

\subsection{Milestones (productos mínimamente viables)}

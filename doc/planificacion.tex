...
Todo el proceso de creación del proyecto ha sido gestionado y documentado en el repositorio de {\textbf{GitHub}}: \url{https://github.com/rocalbbeb/tfg.git}

A partir del seguimiento realizado en el repositorio, este apartado recoge los milestones o productos mínimamente viables definidos durante el desarrollo. Cada uno de ellos representa un hito del trabajo que refleja el progreso alcanzado en distintas fases del proyecto.

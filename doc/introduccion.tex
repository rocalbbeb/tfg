...
En este capítulo, se expone la metodología seguida en el desarrollo del proyecto. 
...
Para ello, se han definido \textbf{historias de usuario} que reflejan las necesidades y expectativas del tribunal en relación con el proyecto. Estas sirven como guía para priorizar y estructurar las tareas, y se han recogido en el repositorio del proyecto mediante \textit{issues} de GitHub. Cada \textit{issue} representa una tarea concreta cuyo cumplimiento satisface una historia de usuario.

El desarrollo se ha organizado en \textbf{hitos} o, en GitHub, \textit{milestones}, que agrupan varias historias de usuario en versiones concretas del proyecto. Cada \textit{milestone} representa un estado alcanzable y verificable del desarrollo, y su descripción refleja el progreso y las funcionalidades incorporadas. 

La gestión del flujo de trabajo se ha llevado a cabo mediante un tablero \textbf{Kanban}, integrado en GitHub Projects, que permite visualizar el estado de cada tarea (pendiente, en progreso, completada) y facilita el seguimiento continuo del proyecto.

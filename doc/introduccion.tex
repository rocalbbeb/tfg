...
Tanto las historias de usuario (\textit{issues}) como los \textit{milestones} están documentados en GitHub, lo que permite un seguimiento claro del avance del proyecto, así como mantener una organización en el mismo. Además, estas herramientas ayudan a asegurar y verificar que los requisitos definidos se corresponden con el trabajo realizado. 

...
En el presente capítulo se detalla la metodología de desarrollo adoptada durante la creación del proyecto, junto con su control y seguimiento. Todo el proceso ha sido gestionado y documentado en un repositorio de GitHub, donde se han registrado las tareas realizadas, los cambios efectuados y las decisiones tomadas. Extrayendo la información del repositorio, queda reflejado en este capítulo de forma precisa la evolución del proyecto.
...
El enfoque de desarrollo ágil permite una evolución progresiva del proyecto. De esta manera, se verifica de forma continua que el trabajo realizado se ajusta a los objetivos esperados, lo que facilita detectar a tiempo desviaciones o cambios necesarios. A diferencia de los enfoques tradicionales, en los que la validación suele ocurrir al final del proceso, el desarrollo ágil permite una supervisión constante y mayor adaptación a lo largo del ciclo de vida del proyecto \cite{AgileAlliance2024}.

\section{Gestión del desarrollo con GitHub}

Para seguir las pautas de la metodología, se han definido \textbf{historias de usuario}, que reflejan las necesidades y expectativas del tribunal en relación con el proyecto. Estas sirven como guía para priorizar y estructurar las tareas, y se han recogido en el repositorio del proyecto mediante \textit{issues} de GitHub. Cada \textit{issue} representa una tarea concreta cuyo cumplimiento satisface una historia de usuario.

La gestión del flujo de trabajo se ha llevado a cabo mediante un tablero \textbf{Kanban}, integrado en GitHub Projects, que permite visualizar el estado de cada tarea (pendiente, en progreso, completada) y facilita el seguimiento continuo del proyecto \cite{GitHubProjects2024}. 
...
La documentación mediante un repositorio de GitHub permite un seguimiento claro del avance del proyecto, así como mantener una organización en el mismo. Además, las \textit{issues} y los \textit{milestones} ayudan a asegurar y verificar que los requisitos definidos se corresponden con el trabajo realizado. 